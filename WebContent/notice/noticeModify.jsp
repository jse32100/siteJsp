	...
	<div class="row">
	    ...
	    <div class="col-md-8 col-md-offset-2">
    		...
    		<form action="modify" method="post" enctype="multipart/form-data"  name="modify" id="modify">
    		  <input type="hidden" name="filenames" value="${board.filename }">
    		  <input type="hidden" name="num" value="${board.num }">
    		    ...
    		    <div class="form-group">
    		        ...
    		        <textarea rows="10" class="form-control" name="description" id="description">${board.description }</textarea>
    		    </div>
    		    
    		    <div class="form-group">
    		        <label for="tag">Tag</label>
    		        <input type="text" class="form-control" value="${board.tag }" name="tag" id="tag">
    		    </div>
    		    
				<div class="form-group">
				  <label for="filename">File Upload</label>
				  <input type="file" name="filename" value="${board.filename }" class="form-control">
					</div>
